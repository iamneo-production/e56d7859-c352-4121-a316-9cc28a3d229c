...
//This is file build using Motoko a programming language (.mo) to deploy 
// directly on to Internet Computer Blockchain.
// Here we build a DAO for our NEW Bank that will essentially run our 
// bank and manage the accounts. Thus, the new digital bank will be completely
// autonomous and be decentralized and secured
